...
Initial release of LANCommander Interposer — a Windows API hook DLL that makes games easier to run in shared, managed, and portable environments without modifying the game itself.
